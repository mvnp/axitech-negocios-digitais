<?php  startit_qode_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
<div class="qodef-blog-holder qodef-blog-type-masonry qodef-masonry-pagination-<?php echo startit_qode_options()->getOptionValue('masonry_pagination'); ?>">
...
<?php
	if( startit_qode_options()->getOptionValue('pagination') == 'yes') {
		...
		$pagination_type = startit_qode_options()->getOptionValue('masonry_pagination');
