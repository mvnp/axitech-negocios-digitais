...
if(!function_exists( 'startit_qode_title_type_class' )) {
    /**
     ...
     */
    function startit_qode_title_type_class($classes) {
    ...
    add_filter('qode_startit_title_classes', 'startit_qode_title_type_class');
}

if(!function_exists( 'startit_qode_title_background_image_classes' )) {
    function startit_qode_title_background_image_classes($classes) {
        //init variables
        $id                         = startit_qode_get_page_id();
        $is_img_responsive 		    = '';
        $is_image_parallax		    = '';
        ...
        if(get_post_meta($id, "qodef_title_area_background_image_meta", true) != ""){
            ...
            $title_img = startit_qode_options()->getOptionValue('title_area_background_image');
        }
        ...
        if(get_post_meta($id, "qodef_title_area_background_image_parallax_meta", true) != ""){
            ...
            $is_image_parallax = startit_qode_options()->getOptionValue('title_area_background_image_parallax');
        }
    ...
    add_filter('qode_startit_title_classes', 'startit_qode_title_background_image_classes');
}

if(!function_exists( 'startit_qode_title_content_alignment_class' )) {
    /**
     ...
     * @return array changed array of classes
     */
    function startit_qode_title_content_alignment_class($classes) {
        ...
        if(get_post_meta($id, "qodef_title_area_content_alignment_meta", true) != "") {
            ...
            $title_content_alignment = startit_qode_options()->getOptionValue('title_area_content_alignment');
        }
    ...
    add_filter('qode_startit_title_classes', 'startit_qode_title_content_alignment_class');
}

if(!function_exists( 'startit_qode_title_animation_class' )) {
    /**
     * Function that adds class on title based on title animation option
     * @param $classes original array of classes
     * @return array changed array of classes
     */
    function startit_qode_title_animation_class($classes) {
        ...
        if(get_post_meta($id, "qodef_title_area_animation_meta", true) !== "") {
            ...
            $title_animation = startit_qode_options()->getOptionValue('title_area_animation');
        }
    ...
    add_filter('qode_startit_title_classes', 'startit_qode_title_animation_class');
}

if(!function_exists( 'startit_qode_title_background_image_div_classes' )) {
    function startit_qode_title_background_image_div_classes($classes) {
    ...
    add_filter('qode_startit_title_classes', 'startit_qode_title_background_image_div_classes');
}