...
if ( ! function_exists( 'startit_qode_social_options_map' ) ) {

	function startit_qode_social_options_map() {
		 ...
		 * Enable Social Share
		 */
		$panel_social_share = startit_qode_add_admin_panel(array(
			'page'  => '_social_page',
		...
		$panel_show_social_share_on = startit_qode_add_admin_panel(array(
			'page'  			=> '_social_page',
		 ...
		 */
		$panel_social_networks = startit_qode_add_admin_panel(array(
			'page'  			=> '_social_page',
		...
		$enable_facebook_share_container = startit_qode_add_admin_container(array(
		...
		$enable_twitter_share_container = startit_qode_add_admin_container(array(
		...
		$enable_linkedin_container = startit_qode_add_admin_container(array(
		...
		$enable_tumblr_container = startit_qode_add_admin_container(array(
		...
		$enable_pinterest_container = startit_qode_add_admin_container(array(
		...
		$enable_vk_container = startit_qode_add_admin_container(array(
        ...
        if( startit_qode_is_plugin_installed('twitter-feed') ) {

            $panel_twitter_login = startit_qode_add_admin_panel(array(
                'page'  => '_social_page',
	...
	add_action( 'qode_startit_options_map', 'startit_qode_social_options_map', 16);
