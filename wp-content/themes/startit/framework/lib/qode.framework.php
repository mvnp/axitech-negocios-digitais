...
class QodeStartitFramework {
    ...
    private function __construct() {
        $this->qodeOptions = QodeStartitOptions::get_instance();
        $this->qodeMetaBoxes = QodeStartitMetaBoxes::get_instance();
    }
	...
	public function setSkin(QodeStartitSkinAbstract $skinObject) {
		$this->skin = $skinObject;
	}
}

/**
 * Class QodeStartitSkinManager
 *
...
/**
 * Class QodeStartitSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class QodeStartitSkinAbstract {
    /**
     * @var string
     */
    protected $skinName;
    ...
    public function setShortcodeJSParams() { ?>
		<script>
			window.qodeSCIcon = '<?php echo startit_qode_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
...
/*
   Class: QodeStartitAdminPage
   A class that initializes Qode Admin Page
*/
class QodeStartitAdminPage implements iQodeStartitLayoutNode {
    ...
    function __construct($slug="", $title="", $icon = "") {
        $this->layout = array();
        $this->factory = new QodeStartitFieldFactory();
        $this->slug = $slug;
        $this->title = $title;
        $this->icon = $icon;
    }
    ...
    public function renderChild(iQodeStartitRender $child) {
        $child->render($this->factory);
    }
}

/*
   Class: QodeStartitMetaBoxes
...
/*
   Class: QodeStartitMetaBox
   A class that initializes Qode Meta Box
*/
class QodeStartitMetaBox implements iQodeStartitLayoutNode {
	...
	public function setTitle($label) {
		...
		return $qode_startit_Framework->getSkin()->getSkinLabel().' '.$label;
 	}
}
