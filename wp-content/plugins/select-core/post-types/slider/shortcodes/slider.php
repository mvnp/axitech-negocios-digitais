...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            $slider_header_effect = isset($slider_meta['header_effect']) ? $slider_meta['header_effect'] : '';
            ...
            $slider_navigation_effect = isset($slider_meta['navigation_effect']) ? $slider_meta['navigation_effect'] : '';
