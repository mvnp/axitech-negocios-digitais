<?php
if ( ! function_exists( 'qode_core_init_google_fonts_array' ) ) {
	function qode_core_init_google_fonts_array() {
...
';
		...
		$qode_startit_fonts_array = $google_fonts_decoded['items'];
	}
	add_action('after_setup_theme', 'qode_core_init_google_fonts_array');
}