<div class="qodef-elements-holder-item <?php echo esc_attr($elements_holder_item_class); ?>" <?php echo startit_qode_get_inline_style($elements_holder_item_style); ?>>
	<div class="qodef-elements-holder-item-inner">
		<div class="qodef-elements-holder-item-content <?php echo esc_attr($elements_holder_item_content_class); ?>" <?php echo startit_qode_get_inline_style($elements_holder_item_content_style); ?>>
