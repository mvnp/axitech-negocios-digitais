...
class StartitCoreElementorPieChartDoughnut extends \Elementor\Widget_Base{
	
	private $chartFields = 10;
	
    public function get_name() {
        return 'qodef_pie_chart_doughnut';
    }

    public function get_title() {
        return esc_html__( "Select Pie Chart 3 (Doughnut)", 'select-core' );
    }
    ...
    protected function render(){
	    ...
	    echo qode_core_get_independent_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
    }
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new StartitCoreElementorPieChartDoughnut() );