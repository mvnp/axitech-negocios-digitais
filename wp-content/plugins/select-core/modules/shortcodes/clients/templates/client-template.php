<?php
if($image != '') {  ?>
	<div class="qodef-client-holder <?php echo esc_attr($class);?>" <?php echo startit_qode_get_inline_style($client_styles); ?>>
                ...
                <?php } ?>
					...
					<?php if($hover_image != '') {  ?>
						<span class="qodef-client-hover-image">
							<img src="<?php echo esc_url($hover_image); ?>" alt="<?php echo esc_attr($hover_image_alt); ?>" />
						</span>
					<?php } ?>
				<?php if($link != '') { ?>
					</a>
