...
<div class="qodef-fullwidth-slider-item" <?php echo startit_qode_get_inline_style($slide_holder_style); ?>>
    <div class="qodef-fullwidth-slider-item-image-holder-wrapper">
        <span class="qodef-fullwidth-slider-item-image-holder">
            <img src="<?php print esc_url($image); ?>" alt="qodef-fullwidth-slider"/>
        </span>
    </div>
