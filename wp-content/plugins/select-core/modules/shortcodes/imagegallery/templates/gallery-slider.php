<div class="qodef-image-gallery <?php echo esc_attr($slider_gallery_classes)?>">
	<div class="qodef-image-gallery-slider" <?php echo startit_qode_get_inline_attrs($slider_data); ?>>
    ...
    <?php if ($image_frame == 'yes') { ?>
        <div class="qodef-gallery-frame">
            <img src="<?php echo esc_url(QODE_ROOT . "/assets/img/slider_frame-5.png"); ?>" />
        </div>
    <?php } ?>
</div>