...
class CustomFont implements ShortcodeInterface {
		...
		vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						"value" => startit_qode_get_font_style_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						...
						"value" => startit_qode_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => startit_qode_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = qode_core_get_independent_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
