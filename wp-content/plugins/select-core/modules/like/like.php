...
class QodeStartitLike {
	...
	public function add_like() {
		...
		return '<a href="#" class="'. $class .'" id="qodef-like-'. $post->ID .'" title="'. esc_attr($title) .'">'. $output .'</a>';
	}
	...
	public function add_like_portfolio_list($portfolio_project_id){
		...
		return '<a class="'. $class .'" data-type="portfolio_list" id="qodef-like-'. $portfolio_project_id .'" title="'. esc_attr($title) .'"></a>';
	}
	...
	public function add_like_blog_list($blog_id){
		...
		return '<a class="hover_icon '. $class .'" data-type="portfolio_list" id="qodef-like-'. $blog_id .'" title="'. esc_attr($title) .'"></a>';
	}
