...
class QodeStartitSearchOpener extends QodeStartitWidget {
    ...
    public function widget($args, $instance) {
        ...
        <a <?php echo startit_qode_get_inline_attr($instance['search_icon_hover_color'], 'data-hover-color'); ?>
			<?php if ( $close_icon_on_same_position ) {
				echo startit_qode_get_inline_attr('yes', 'data-icon-close-same-position');
			} ?>
            <?php startit_qode_inline_style($search_opener_styles); ?>
            <?php startit_qode_class_attribute($search_type_class); ?> href="javascript:void(0)">
