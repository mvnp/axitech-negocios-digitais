...
if( ! function_exists('qode_core_is_revolution_slider_installed') ){
    function qode_core_is_revolution_slider_installed(){
        return class_exists( 'RevSliderFront' );
    }
}

if(!function_exists( 'qode_core_is_woocommerce_installed' )) {
    /**
     * Function that checks if woocommerce is installed
     * @return bool
     */
    function qode_core_is_woocommerce_installed() {
        return function_exists('is_woocommerce');
    }
}

if( ! function_exists('qode_core_is_layer_slider_installed') ){
    function qode_core_is_layer_slider_installed(){
        return defined('LS_PLUGIN_VERSION');
    }
}

if( ! function_exists('qode_core_is_elementor_installed') ){
	function qode_core_is_elementor_installed(){
...
if ( ! function_exists( 'qode_core_get_module_template_part' ) ) {
    /**
     ...
     * @return html
     */
    function qode_core_get_module_template_part( $module, $template, $slug = '', $params = array() ) {
...
if ( ! function_exists( 'qode_core_ajax_status' ) ) {

    function qode_core_ajax_status( $status, $message, $data = null ) {
...
if( ! function_exists( 'select_core_is_theme_registered' ) ) {
	function select_core_is_theme_registered() {
		return class_exists('SelectCoreDashboard') ? SelectCoreDashboard::get_instance()->is_theme_registered() : true;
	}
}
