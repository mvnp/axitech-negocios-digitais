					...
					<div class="qodef-cd-box-inner">
						<form method="post" class="qodef-cd-import-form" data-confirm-message="<?php esc_attr_e('Are you sure, you want to import Demo Data now?', 'qodef-cpt'); ?>">
							<div class="qodef-cd-box-form-section">
								<?php echo qode_core_get_module_template_part('core-dashboard/sub-pages/import', 'notice', ''); ?>
								<label class="qodef-cd-label"><?php esc_html_e('Select Demo to import', 'qodef-cpt'); ?></label>
								<select name="demo" class="qodef-import-demo">
									<option value="startit-bakery" data-thumb="<?php echo QODE_CORE_URL_PATH . '/core-dashboard/assets/img/demo-bakery.png'; ?>"><?php esc_html_e('StartIt - WPBakery', 'qodef-cpt'); ?></option>
									<option value="startit1-bakery" data-thumb="<?php echo QODE_CORE_URL_PATH . '/core-dashboard/assets/img/demo-bakery.png'; ?>"><?php esc_html_e('StartIt OnePage Demo - WPBakery', 'qodef-cpt'); ?></option>
                                    <option value="startit-elementor" data-thumb="<?php echo QODE_CORE_URL_PATH . '/core-dashboard/assets/img/demo-elementor.png'; ?>"><?php esc_html_e('StartIt - Elementor', 'qodef-cpt'); ?></option>
									<option value="startit1-elementor" data-thumb="<?php echo QODE_CORE_URL_PATH . '/core-dashboard/assets/img/demo-elementor.png'; ?>"><?php esc_html_e('StartIt OnePage Demo - Elementor', 'qodef-cpt'); ?></option>
								</select>
							</div>
