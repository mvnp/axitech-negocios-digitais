...
if ( ! class_exists( 'SelectCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class SelectCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'qodef_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	SelectCoreDashboardRestAPI::get_instance();
}
